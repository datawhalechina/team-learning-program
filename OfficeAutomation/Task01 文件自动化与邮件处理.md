...
- [Task 01 文件自动化处理](#task-01-文件自动化处理)
  - [1.1文件处理](#11文件处理)
    ...
    - [1.1.7 练习](#117-练习)
    - [1.1.8  组织文件](#118--组织文件)
      - [1.1.1.8.1 shutil模块](#11181-shutil模块)
      - [1.1.1.8.2 复制文件和文件夹](#11182-复制文件和文件夹)
      - [1.1.8.3 文件和文件夹的移动与改名](#1183-文件和文件夹的移动与改名)
      - [1.1.8.4 永久删除文件和文件夹](#1184-永久删除文件和文件夹)
      - [1.1.8.5 用send2trash模块安全地删除](#1185-用send2trash模块安全地删除)
    - [1.1.9 遍历目录树](#119-遍历目录树)
    - [1.1.10 用zipfile模块压缩文件](#1110-用zipfile模块压缩文件)
      - [1.1.10.1 创建和添加到zip文件](#11101-创建和添加到zip文件)
      - [1.1.10.2 读取zip文件](#11102-读取zip文件)
      - [1.1.10.3 从zip文件中解压缩](#11103-从zip文件中解压缩)
    - [1.1.11 练习](#1111-练习)
